...
def main():
    ...
    while True:
        ...
        if redCount == 0 and greenCount == 0:
            cv2.putText(frame, "lights out", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 8)
        elif redCount > greenCount:
            cv2.putText(frame, f"red light {redCount}/{greenCount}", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 8)
        else:
            cv2.putText(frame, f"green light {redCount}/{greenCount}", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 8)
